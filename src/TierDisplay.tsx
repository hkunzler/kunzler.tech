...
const tiers = [
  ...
  },
  {
    ...
    subscription: '$0 down, starting at $300/month for site maintenance and support'
  },
];

export const TierDisplay = () => {
  return (
    <Section id="tiers" secondary align='center' justify='center' vertical gap={'middle'}>
    <StyledTitle level={2} secondary>Tier Options</StyledTitle>
    <TierOptions>
